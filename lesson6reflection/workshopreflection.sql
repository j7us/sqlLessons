...
-- 1) Упущена функция ROUND в делении и приведение к DECIMAL
-- 2) Неправильно посчитана корреляция для skill_quality_correlation
-- 3) К сожалению не использована функция AVG при подсчете среднего количества
-- 4) Не учтен столбец created by в случае продукта, сделанного гномами