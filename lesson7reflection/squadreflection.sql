...
-- 1) Не учтены столбцы поражений и ничьи
-- 2) Не учтены столбцы выхода дварфов из команды
-- 3) Не посчитаны столбцы среднего прогрессий уровня
-- 4) Не посчитан столбец общей эффективности