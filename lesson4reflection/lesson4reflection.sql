-- Получение данных о гноме с навыками и назначениями
select d.dwarf_id,
       d.name,
       d.age,
       d.profession,
...
-- Данные о мастерской с назначенными рабочими и проектами
...
-- Данные о военном отряде с составом и операциями
select ms.squad_id,
       ms.name,
       ms.formation_type,
       ms.leader_id,
