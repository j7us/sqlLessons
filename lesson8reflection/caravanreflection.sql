...
-- 1) Неправильно понял задание и начал строить всю логику, отталкиваясь от группировки по крепостям.
-- 2) Стоило продолжать использование JSON_ARRAYAGG и не добавлять использование JSON_ARRAY
-- 3) Не использовал аллиасы для Json_object
-- 4) Не учтены связи с caravan_goods
-- 5) Не посчитаны или не учтены некоторые поля